...
<style>
body{
	background:url("images/dish1.jpg");
...
<div style="margin-top:5%;background-color: #ff5e81;height:50px;"><h2>ALL USERS</h2></div>	<table border="1">
		<tr>
		...
		<%
			try {
				...
				String sql = "select * from bakery_user";
